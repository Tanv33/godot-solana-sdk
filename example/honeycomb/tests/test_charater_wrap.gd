...
func before_all():
	...
	assembler_config = await base.create_assembler_config(client, project, traits.order, traits.traits)
	#print("assembler_config: ",assembler_config)
	
	character_model = await base.create_character_model_raw(client, project, assembler_config.address)
